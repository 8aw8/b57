...
begin
 ...
 SQL_text.Clear;
 SQL_text.Add( 'SELECT ad.name_driver AS "ФИО водителя", ad.tel_driver AS "Телефон водителя", ad.address AS "Адрес водителя", ad.avto_driver_id FROM avto_driver ad');
